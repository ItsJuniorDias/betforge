...
export type Sport = 'football' | 'basketball' | 'tennis' | 'mma' | 'esports' | 'baseball' | 'hockey' | 'americanfootball';
...
export type NotificationType = 'bet_settled' | 'deposit_confirmed' | 'withdraw_processed' | 'promotion' | 'system';
