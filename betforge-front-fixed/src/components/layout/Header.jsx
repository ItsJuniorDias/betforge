    ...
    <header className="h-[60px] bg-[#111318] border-b border-white/[0.06] flex items-center justify-between px-6 sticky top-0 z-50">
      ...
      <div className="flex items-center gap-2">
        ...
        <button onClick={() => navigate("/notifications")}
          ...
          🔔
          {unreadCount > 0 && (
            <span className="absolute -top-1.5 -right-1.5 bg-[#C9A84C] text-black text-[10px] font-bold min-w-[18px] h-[18px] px-0.5 rounded-full flex items-center justify-center">
