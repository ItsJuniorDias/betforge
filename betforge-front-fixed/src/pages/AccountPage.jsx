    ...
    <div className="p-5 max-w-full mx-auto">
      ...
      {activeTab === "Visão Geral" && (
        <div className="space-y-6">
          ...
          {/* Atalho para Extrato Financeiro */}
          <div
            onClick={() => navigate("/transactions")}
            className="bg-[#111318] border border-white/[0.06] hover:border-[#C9A84C]/30 rounded-xl p-4 flex items-center justify-between cursor-pointer transition-all group"
          >
            <div className="flex items-center gap-3">
              <span className="text-2xl">💳</span>
              <div>
                <p className="text-sm font-semibold text-[#F0EDE6]">Extrato Financeiro</p>
                <p className="text-xs text-[#5A5750]">Depósitos, saques e movimentações</p>
              </div>
            </div>
            <span className="text-[#C9A84C] text-xs group-hover:underline">Ver extrato →</span>
          </div>
        </div>
      )}
