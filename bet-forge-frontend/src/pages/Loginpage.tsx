      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="bg-[#111318] border border-white/[0.06] rounded-2xl p-6">
          ...
          <div className="flex items-center gap-3 my-5">
            ...
            <span className="text-[11px] text-[#5A5750]">ou continue com</span>
            <div className="flex-1 h-px bg-white/[0.05]" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <button
                key={s.label}
                className="bg-[#181C23] border border-white/[0.06] hover:border-white/20 text-[#9B9590] hover:text-[#F0EDE6] text-sm py-2.5 rounded-xl transition-all flex items-center justify-center gap-2"
              >
                <span>{s.icon}</span>
                {s.label}
              </button>
