...
export const BetController = {
  ...
  // ── Admin: liquida aposta manualmente (com picks explícitos) ─────────────
  ...
  // ── Admin: força o settlement automático imediatamente ───────────────────
  async forceSettle(req: Request, res: Response) {
    await SettlementService.settleFinishedMatches();
    return Res.success(res, null, 'Settlement executado. Verifique os logs para detalhes.');
  },
};
